...
class Server:
    ...
    def __init__(self):
        ...
        self.process_discovery_connections_forever()
    ...
    def create_discovery_socket(self):
        try:
            ...
            self.socket.bind( (Server.HOSTNAME, Server.SERVICE_DISCOVERY_PORT) )
        ...
        while True:
            try:
                ...
                if Server.SCAN_CMD in recvd_str:
                    ...
                    # the client.
                    self.socket.sendto(Server.FILESHARE_ENCODED, address)
                    return
